module github.com/sonirico/vago/testit
...
require (
	...
	go.elastic.co/apm/module/apmgoredisv8/v2 v2.7.2 // indirect
	go.elastic.co/apm/module/apmmongo/v2 v2.7.2 // indirect
	go.elastic.co/apm/module/apmpgxv5/v2 v2.7.2 // indirect
